...
<?php 
    $sql_sanpham=mysqli_query($con,"SELECT * FROM tbl_cartegory,tbl_sanpham WHERE tbl_cartegory.cartegory_id=tbl_sanpham.cartegory_id AND tbl_sanpham.cartegory_id='$_GET[id]' ORDER BY tbl_sanpham.sanpham_id DESC");             

?>
<?php 
    $sql_sanphamm=mysqli_query($con,"SELECT * FROM tbl_cartegory,tbl_sanpham WHERE tbl_cartegory.cartegory_id=tbl_sanpham.cartegory_id AND tbl_sanpham.cartegory_id='$_GET[id]' ORDER BY tbl_sanpham.sanpham_id DESC");
                ...
                <div class="cartegory-right row">
                   ...
                   <!--  <div class="cartegory-right-top-item">
                    ...
                    <div class="cartegory-right-content-container">
                        <div class="cartegory-right-content row" style="margin-left: 45px; display: inline-flex;justify-content: flex-start;">
                        <?php 
